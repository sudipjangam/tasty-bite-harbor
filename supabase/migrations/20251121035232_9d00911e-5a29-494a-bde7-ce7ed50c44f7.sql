...
DROP FUNCTION IF EXISTS public.get_analytics_data(uuid, text, text);

-- Create improved analytics aggregation function
...
GRANT EXECUTE ON FUNCTION public.get_analytics_data(uuid, text, text) TO authenticated;