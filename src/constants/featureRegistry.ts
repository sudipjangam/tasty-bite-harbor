...
// ─── QSR-POS ──────────────────────────────────────────────────────
  ...
  // ─── Kitchen ──────────────────────────────────────────────────────────
  {
    ...
    features: [
      ...
      { key: 'kitchen.voice_calls', label: 'Vernacular Voice Order Calls', description: 'Multi-lingual text-to-speech announcer in Hindi, Telugu, Marathi, Gujarati, Bengali, Tamil, etc.' },
      { key: 'kitchen.throttle', label: 'Kitchen Prep Load Throttle', description: 'Real-time cooking queue load gauge, dynamic surge buffer, and 1-touch store pause' },
