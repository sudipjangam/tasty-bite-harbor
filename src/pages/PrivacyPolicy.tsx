    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <p>
            This Privacy Policy describes how Swadeshi Solutions and its
            affiliates (collectively "Swadeshi Solutions, we, our, us") collect,
            use, share, protect or otherwise process your information/ personal
            data through our website https://swadeshisolutions.co.in
          ...
          <p>
            ...
            email, a call from a person/association claiming to be Swadeshi
            Solutions seeking any personal data like debit/credit card PIN,
          ...
          <p>
            Insert Name of the Office: Grievance Officer
            <br />
            Designation: Grievance Officer
            <br />
            Insert Name and Address of the Company: Swadeshi Solutions, Satara,
            MH 412803
            <br />
            Contact us: inquiry@swadeshisolutions.co.in
            <br />
            Phone: +91 8308903224
            <br />
