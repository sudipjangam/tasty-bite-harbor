    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 border-b pb-4">Terms & Conditions</h1>
          ...
          <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://swadeshisolutions.co.in ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>
          <p>The Platform is owned by Swadeshi Solutions, a company incorporated under the Companies Act, 1956 with its registered office at 1208, Chilai Nagar, Ozarde, tal- wai, Dist - satara (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').</p>
