...
export const useFinancialTrends = () => {
  ...
  return useQuery({
    queryKey: ["financial-trends", restaurantId],
    queryFn: async () => {
      ...
      const currentExpenseTotal =
        currentExpenses?.reduce((sum, expense) => sum + expense.amount, 0) || 0;
      ...
      const marginGrowth =
        previousMargin !== 0 ? currentMargin - previousMargin : 0;

      // Calculate outstanding invoices
      const outstandingInvoicesTotal =
        invoices?.reduce(
