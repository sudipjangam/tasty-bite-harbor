...
export const FranchiseLayout: React.FC = () => {
  ...
  const currentUserRole =
    user?.role_name_text || user?.role || "Franchise Member";
    ...
    <FeatureLock feature="franchise.dashboard" interceptClicks={true}>
      <div className="flex h-screen overflow-hidden bg-background">
        ...
        >
          ...
          {/* Demo Mode Switch (Desktop Sidebar) — admin/owner only */}
            ...
            <div className="px-4 py-3 border-t border-white/10 bg-slate-950/20">
              <div className="flex items-center justify-between gap-2">
                ...
                <Switch
                  ...
                  className={
                    demoMode ? "data-[state=checked]:bg-amber-500" : ""
                  }
                />
              </div>
            </div>
            ...
            {demoMode && (
              <div className="bg-amber-50 dark:bg-amber-950/30 border-b border-amber-200 dark:border-amber-900/30 px-4 py-2.5 flex items-center gap-3">
                ...
                <p className="text-xs text-amber-700 dark:text-amber-300">
                  <span className="font-bold">Demo Mode Active</span> — Showing
                  rich mockup metrics for presentation. Toggle off to connect
                  live tables.
                </p>
              </div>
            )}
