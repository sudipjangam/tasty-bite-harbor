...
export const EnhancedStats = () => {
  ...
  // Exclude non-chargeable orders from revenue calculations
  ...
  const trendData = React.useMemo(() => {
    if (!allRevenueSources || allRevenueSources.length === 0)
      return { historical: [], forecast: [], categories: [] };
    ...
    return {
      ...
      forecast,
      categories: [
        ...last14Days.map((date) => new Date(date).toLocaleDateString()),
        ...next7Days,
      ],
    };
  }, [allRevenueSources]);
