...
import { Utensils, TrendingUp, Flame, ChefHat, Calendar } from "lucide-react";
...
const TrendingItems = () => {
  ...
  const { data: trendingItems, isLoading } = useTrendingItems(period);
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">
              Top selling dishes this {period === "weekly" ? "week" : "month"}
            </p>
          </div>
        </div>
