...
const StatCard = ({
  ...
  return (
    <Card
      className={`group relative overflow-hidden border-0 cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] ${
        shadow || "shadow-lg"
      }`}
      onClick={onClick}
    >
      ...
      <CardContent className="relative z-10 p-6 flex flex-col h-full justify-between">
        <div className="flex justify-between items-start mb-2">
          ...
          <div className="px-2.5 py-1 rounded-xl backdrop-blur-md bg-white/90 dark:bg-white/20 border border-white/30 flex items-center gap-1 shadow-sm">
