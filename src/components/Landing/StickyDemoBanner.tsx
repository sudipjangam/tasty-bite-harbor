      ...
      <div className="bg-[#1E1E34]/95 backdrop-blur-md border-t border-gray-700/50 shadow-2xl">
        <div className="container mx-auto px-3 sm:px-4 py-2 sm:py-3 flex items-center justify-between gap-2 sm:gap-4">
          <div className="flex items-center gap-2 sm:gap-3 text-white min-w-0">
            ...
            <p className="text-[11px] sm:text-sm font-medium truncate sm:whitespace-normal">
              <span className="hidden sm:inline">
                Not sure if this fits your restaurant?{" "}
              </span>
              <span className="font-bold">
                Free 20-min WhatsApp demo.
              </span>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1 sm:gap-1.5 px-3 py-1.5 sm:px-4 sm:py-2 rounded-xl bg-gradient-to-r from-[#25D366] to-[#128C7E] text-white text-[11px] sm:text-xs font-bold shadow-md hover:scale-105 transition-transform whitespace-nowrap"
            >
