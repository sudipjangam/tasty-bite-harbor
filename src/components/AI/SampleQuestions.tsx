        ...
        <div className="space-y-2 pr-2">
          {sampleQuestions.map((item, index) => (
            <button
              ...
              className="w-full p-2 bg-gradient-to-br from-white/80 to-gray-50/80 dark:from-gray-700/80 dark:to-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group text-left"
            >
              <div className="flex items-start gap-2">
                <div className="text-sm bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-lg p-1 shadow-md group-hover:shadow-lg transition-all duration-300">
                  {item.icon}
                </div>
                <div className="flex-1">
                  ...
                  <p className="text-xs font-medium text-gray-900 dark:text-gray-100 group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors duration-200 leading-relaxed">
                    {item.question}
                  </p>
                </div>
