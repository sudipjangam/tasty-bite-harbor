        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 bg-white dark:bg-gray-900">
          ...
          {startDate && endDate && (
            <div className="py-4 px-4 rounded-xl bg-violet-50 dark:bg-violet-900/20 border-2 border-violet-200 dark:border-violet-800 flex items-center justify-between">
              <span className="text-sm font-semibold text-violet-700 dark:text-violet-300">Total Duration</span>
          ...
          {isEditMode && leave && (
            <div className={`p-4 rounded-xl border-2 ${
              leave.status === 'approved' ? 'bg-emerald-50 border-emerald-200 dark:bg-emerald-900/20 dark:border-emerald-800' :
              leave.status === 'denied' ? 'bg-red-50 border-red-200 dark:bg-red-900/20 dark:border-red-800' :
              ...
              <div className="flex items-center justify-between">
                ...
                <Badge className={`px-3 py-1 font-semibold ${
                  ...
                  leave.status === 'denied' ? 'bg-red-500 text-white' :
