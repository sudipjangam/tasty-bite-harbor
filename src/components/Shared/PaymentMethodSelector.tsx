// Move the existing PaymentMethodSelector.tsx content here from CheckoutComponents folder
// Keep the code exactly the same, just move it to this new location
