...
export const QSOrderHistory: React.FC<QSOrderHistoryProps> = ({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent
        side="right"
        className="w-full sm:w-[400px] bg-gray-900 border-white/10 text-white p-0"
      >
        <SheetHeader className="px-4 py-4 border-b border-white/10 bg-gradient-to-r from-orange-500/10 to-pink-500/10">
          ...
          <div className="flex items-center justify-between mt-2">
            ...
            <span className="text-sm font-bold bg-gradient-to-r from-orange-400 to-pink-400 bg-clip-text text-transparent">
              {currencySymbol}
